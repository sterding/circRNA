...
bedtools closest -a <(awk 'NR>1 {OFS="\t"; print "chr"$10,$3-$2,$3-$2+1,$0;}' $circRNA_annotation | sortBed) -b <(awk 'NR>1{OFS="\t"; print "chr"$10,$3-$2,$3-$2+1,$0;}' $circRNA_annotation.background | sortBed) -t all > /scratch/x/xd010/$circRNA_annotation.matched2all
...
# choose the first hit from the ties
bedtools closest -a <(awk 'NR>1 {OFS="\t"; print "chr"$14,$3-$2,$3-$2+1,$0;}' $circRNA_annotation | sortBed) -b <(awk '{OFS="\t"; print "chr"$14,$3-$2,$3-$2+1,$0;}' $circRNA_annotation.background | sortBed) -t all > /scratch/x/xd010/$circRNA_annotation.matched3all
