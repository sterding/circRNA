...
dis=args[4] # 1e6
dis=ifelse(is.na(args[1]),1e5,as.numeric(args[1]))

# i=1; Rdata="data.RData"; expr="expression.postSVA.xls"; dis=1e5
...
me2 = Matrix_eQTL_main(
  ...
  verbose = FALSE,
  output_file_name.cis = paste0("/tmp/permutation",i,".txt"),
...
saveRDS(mpg,paste0("permutations/permutation",i,".rds"))